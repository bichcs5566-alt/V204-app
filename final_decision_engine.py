...
v266.9.3 data_lookup 穩定版：多來源補資料層
...
def make_lookup():
    ...
    for c in ["close", "volume", "turnover", "liquidity_level", "liquidity_tag", "liquidity_score"]:
...
def main():
    ...
    summary = {
        ...
        "source": "final_decision_engine_v266_9_3_data_lookup",
        "rows": int(len(out)),
