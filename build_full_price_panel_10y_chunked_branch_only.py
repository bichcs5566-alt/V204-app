# build_full_price_panel_10y_chunked_branch_only.py
# 建立 10 年台股資料，切成多個 <100MB CSV 分片後提交到 repo 的新 branch
# 不自動開 PR，避免 repo 禁止 Actions 建 PR 的限制
#
# 產出：
...
def main():
    ...
    log("=== build_full_price_panel_10y_chunked_branch_only start ===")
    ...
    log("=== build_full_price_panel_10y_chunked_branch_only done ===")
